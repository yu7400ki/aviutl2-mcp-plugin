...
mod tests {
    use super::*;
    use crate::read::host::{HostEffectFacets, HostEffectHelp, HostEffectSummary, ReadHost};
    ...
    impl ReadHost for FakeRenderHost {
        ...
        fn effect_items(
            &self,
            _effect_name: &str,
        ) -> Result<Vec<aviutl2_mcp_core::AvailableEffectItem>, ReadError> {
            Ok(Vec::new())
        }
        ...
        fn effect_facets(&self, _effect_name: &str) -> HostEffectFacets {
            HostEffectFacets::default()
        }
